...
if not st.session_state.get("logged_in"):
    ...
    components.html(f"""
    <style>
        body {{ margin: 0; background: transparent; font-family: 'Roboto', 'Inter', -apple-system, sans-serif; }}
        .google-btn {{
            display: inline-flex;
            align-items: center;
            gap: 12px;
    ...
    <div class="btn-wrap">
        <button class="google-btn" onclick="window.top.location.href='{login_url}'">
