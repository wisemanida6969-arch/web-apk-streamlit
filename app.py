...
# with ?_ptxn=<transaction_id>. This repository's sister apps (PetLog,
# PostGenie) generate those transactions and Paddle sends users here
# because trytimeback.com is the account's default approved domain.
#
# To render the checkout, inject Paddle.js and call
